...
| Термин | Определение |
|---|---|
| **Circadian rhythm** (циркадный ритм) | Внутренние биологические часы с циклом ~24.2ч, управляемые SCN. Регулируют сон, температуру тела, гормоны, метаболизм. У сменных работников принудительно рассинхронизированы с внешним временем. |
| **SCN** (супрахиазматическое ядро) | Главный «пейсмейкер» циркадных ритмов в гипоталамусе. Получает сигнал от глаз (свет/темнота) и синхронизирует все периферические часы в организме. |
| **Zeitgeber** (от нем. «датчик времени») | Внешний синхронизатор циркадных ритмов. Сильнейший — свет. Также: температура, еда, физическая активность, социальные взаимодействия. ShiftRest управляет этими рычагами. |
| **SWSD** (Shift Work Sleep Disorder) | Клиническое расстройство циркадного ритма (ICSD-3): инсомния и/или гиперсомния у людей, чьи рабочие часы перекрываются с типичным временем сна. Распространённость: 26.5% сменных работников. |
| **Sleep debt** (долг сна) | Накопленный дефицит сна относительно индивидуальной потребности (~7–9ч). Накапливается последовательно, частично «выплачивается» за выходные — но не полностью. |
| **Melatonin** (мелатонин) | Гормон эпифиза, вырабатывается в темноте. Сигнализирует организму о наступлении ночи. Экзогенный мелатонин (0.5–3 мг) используется для сдвига циркадного ритма. Ключевое: время приёма важнее дозы. |
| **Phase Response Curve (PRC)** | Кривая, описывающая как свет или мелатонин в разное время суток сдвигают циркадный ритм вперёд (phase advance) или назад (phase delay). Научная основа для расчёта тайминга мелатонина в ShiftRest. |
| **Phase advance** | Сдвиг циркадного ритма вперёд — засыпание и пробуждение раньше обычного. Достигается: мелатонин вечером, яркий свет утром. Нужен при переходе с ночных смен на дневные. |
| **Phase delay** | Сдвиг циркадного ритма назад — засыпание и пробуждение позже. Достигается: мелатонин утром, яркий свет вечером. Нужен при переходе с дневных смен на ночные. |
| **Chronotype** (хронотип) | Индивидуальная биологическая предрасположенность к «жаворонку» (утренний тип) или «сове» (вечерний тип). Влияет на переносимость смен и оптимальный тайминг всех рекомендаций. |
| **Two-process model** (модель Борбели) | Фундаментальная модель регуляции сна: Process S (sleep pressure — аденозин накапливается во время бодрствования) + Process C (циркадный драйв SCN). ShiftRest моделирует оба процесса. |
| **Sleep inertia** (инерция сна) | Состояние сниженной когнитивной функции и сонливости сразу после пробуждения. Длится 15–30 мин (до 2ч). Критично для смен: просыпаться минимум за 30 мин до выезда. |
| **Power nap** | Короткий сон 15–20 минут. По данным NASA (+34% производительность, +54% бдительность) — оптимальный формат для сменных работников во время перерыва: восстанавливает без инерции сна. |
| **Social jet lag** | Хроническое расхождение между биологическими часами (хронотипом) и социальным расписанием (работа, семья). У сменных работников — постоянное состояние. Главный объект воздействия ShiftRest. |
| **Caffeine half-life** (период полувыведения кофеина) | Время, за которое концентрация кофеина в крови снижается вдвое. Средний показатель: 5–6 часов (диапазон: 3–9ч). Основа для расчёта caffeine cutoff time в ShiftRest. |
| **Adenosine** (аденозин) | Нейромодулятор, накапливающийся в мозге во время бодрствования и создающий «давление сна». Кофеин блокирует аденозиновые рецепторы, временно устраняя сонливость, но не устраняя сам аденозин. |
| **Recovery nap** | Восстановительный сон продолжительностью 90–180 минут после смены. Включает полный цикл сна с SWS и REM. Используется, когда основной сон после смены невозможен сразу. |
| **Continental shift** | Ротационный график сменной работы: 2 дня × 2 ночи × 4 выходных (или вариации). Один из самых тяжёлых для циркадных ритмов — организм переключается каждые 2 дня и никогда не адаптируется полностью. |
| **Melatonin window** | Временной интервал, в течение которого приём мелатонина максимально эффективен для сдвига фазы. Зависит от хронотипа, текущего расписания смен и желаемого направления сдвига. |
| **Non-judgmental scoring** | Принцип оценки сна без штрафов за «нестандартное» время. Дневной сон в 10 утра для ночной медсестры — норма, а не отклонение. Ключевой дизайн-принцип ShiftRest, отличающий его от Sleep Cycle и Oura. |

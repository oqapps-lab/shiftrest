...
const en = {
  ...
  today: {
    ...
    focus: {
      ...
      caffeine_load_title: 'Move your last coffee to {{time}}',
      caffeine_load_body: "You're heavy on caffeine today — making {{time}} your cutoff lets it clear before your sleep window.",
      rough_streak_title: 'Protect your {{time}} recovery nap',
      rough_streak_body: 'A few rough nights this week — a nap at {{time}} pays down the sleep debt without wrecking tonight.',
      night_nap_title: 'Plan a 20-min nap around {{time}}',
      night_nap_body: 'The {{time}} low is your error-risk peak tonight — a short nap there beats sipping coffee all shift.',
      wind_down_title: 'Start winding down for {{time}}',
      wind_down_body: 'Dim the lights and ease off screens now so {{time}} finds you ready to sleep.',
      sleep_window_title: 'Stay asleep until {{time}}',
      sleep_window_body: "You're in your sleep window — keep it dark and quiet through {{time}} for a full block.",
      caffeine_cutoff_title: 'Last coffee by {{time}}',
      caffeine_cutoff_body: 'Stop caffeine at {{time}} so it clears before tonight’s sleep window.',
      steady_title: 'Hold your {{time}} sleep window',
      steady_body: 'Nothing urgent today — keeping {{time}} steady is the move that compounds.',
      locked_title: 'Your one move today',
      locked_cta: 'Unlock your daily focus with Premium',
    },
    ...
    caffeine_lastcall_eyebrow: 'CAFFEINE LAST-CALL',
    caffeine_lastcall_clear: 'Last coffee {{last}} → fades ~{{fades}}, clear for {{sleep}} sleep.',
    caffeine_lastcall_warning: 'Last coffee {{last}} may still be in your system at {{sleep}}. Aim to stop by {{cutoff}}.',
    ...
    journal_ok: 'OK',
    journal_bad: 'Rough',
    journal_hours_prompt: 'HOW LONG? (OPTIONAL)',
    journal_hours_lt5: '<5h',
    journal_hours_5_6: '5–6h',
    ...
    sleep_debt: {
      ...
      body_clears_in: 'Clears in ~{{days}} days of fuller rest.',
      title_clear: "You're caught up",
      body_clear: 'No sleep debt in your logged days — keep it steady.',
      severity_none: 'on track',
      severity_mild: 'mild',
      severity_moderate: 'moderate',
      severity_severe: 'severe',
      empty_title: 'Track your sleep debt',
      empty_body: 'Log your sleep hours (tap your sleep rating, then how long) to start tracking your debt.',
  ...
  safe_to_drive: {
    ...
    framing: 'You just finished a night shift — drowsy driving peaks now.',
    q1: 'How alert do you feel?',
    q1_awake: 'Wide awake',
    q1_foggy: 'A bit foggy',
    q1_empty: 'Running on empty',
    q2: 'Sleep before this shift?',
    q2_7plus: '7h+',
    q2_under6: 'Under 6h',
    risk_low: 'You look good to drive',
    risk_elevated: 'A little risky — try one of these first',
    risk_high: 'Don\'t drive on this — do one of these first',
    rec_good: 'Good — keep the light low and drive safe.',
    rec_nap: 'Nap 20 minutes before you drive.',
    rec_caffeine: 'Cold water + 100 mg caffeine, 30 minutes before driving.',
    rec_rideshare: 'Consider a ride-share, or wait it out before driving.',
    done: 'Got it',
    dismiss_a11y: 'Dismiss the safe-to-drive check for today',
  },
  today_intro: {
  ...
  reveal: {
    ...
    ready: 'Your sleep window is set · caffeine clears {{hours}}h before bed.',
    persona: {
      eyebrow: 'YOUR SLEEP PROFILE',
      title_nurse_night: "You're a rotating night-shift nurse",
      title_nurse_day: "You're a day-shift nurse with rotating cover",
      title_nurse_off: "You're a rotating nurse on a recovery day",
      title_firefighter_night: "You're on a 24-hour firefighter rotation",
      title_firefighter_day: "You're a firefighter between long shifts",
      title_firefighter_off: "You're a firefighter on a recovery day",
      title_factory_night: "You're a night-shift factory worker",
      title_factory_day: "You're a rotating-shift factory worker",
      title_factory_off: "You're a shift worker on a rest day",
      title_generic_night: "You're a night-shift worker",
      title_generic_day: "You're a rotating-shift worker",
      title_generic_off: "You're a shift worker on a rest day",
      body_nurse:
        'Twelve-hour rotations push your body clock back and forth faster than it can adapt, so the 3–5 a.m. alertness dip and the daytime sleep that follows are the hardest parts to manage.',
      body_firefighter:
        'A 24-hour duty cycle means broken sleep on shift and a sleep-debt rebound after — your plan protects an anchor sleep block so recovery actually lands.',
      body_factory:
        'Rotating between days and nights keeps your circadian clock chasing a moving target, which is why falling asleep after a late shift can feel impossible.',
      body_generic:
        'Working against the clock means your body never fully settles into one rhythm — small, well-timed cues do far more than willpower to get you sleeping.',
      chrono_lark: 'As an early type, your natural dip comes sooner, so we nudge your wind-down a little earlier.',
      chrono_intermediate: 'Your mid-range body clock gives us a bit of flexibility to fit sleep around your shifts.',
      chrono_owl: 'As a late type, your clock runs behind the standard day, which we use to time light and sleep later.',
    },
    disruption: {
      eyebrow: 'YOUR SITUATION',
      circadian: 'CIRCADIAN DISRUPTION',
      sleep_debt: 'SLEEP-DEBT RISK',
    ...
    plan: {
      ...
      sub: 'A few well-timed habits do the heavy lifting. Here is what we will build with you.',
      light_title: 'Light & dark protocol',
      light_bullets: [
        'Fall asleep faster after a night shift',
        'Stay alert through the 3 a.m. dip',
        'Reset your clock between rotations',
      ],
      caffeine_title: 'Caffeine timing',
      caffeine_bullets: [
        'Keep the lift when you need it most',
        'Clear it before your sleep window',
        'Cut the wired-but-tired feeling at home',
      ],
      melatonin_title: 'Melatonin timing',
      melatonin_bullets: [
        'Take it at the hour that shifts your clock',
        'Pair it with dark to deepen the effect',
        'Avoid the next-day grogginess',
      ],
      window_title: 'Your sleep window',
      window_bullets: [
        'One protected block, even on rotation',
        'Cooler, darker, quieter for deeper rest',
        'Steadier energy across the whole shift',
      ],
    },
    program: {
      eyebrow: 'YOUR PERSONALISED PROGRAM',
      sub: 'Three plans, built from your answers — unlock to open them.',
      p1_title: 'Sleep Schedule Plan',
      p2_title: 'Light & Caffeine Plan',
      p3_title: 'Recovery & Wind-down Plan',
    },
    included: {
      eyebrow: 'ALSO INCLUDED',
      chronotype: 'Full chronotype breakdown',
      melatonin: 'Exact melatonin dose & timing',
      transitions: 'Shift-transition step plans',
      tracking: 'Progress tracking & re-assessments',
      library: 'The Sleep Library (16 reads)',
    },
    showcase: {
      eyebrow: "WHAT'S INSIDE",
      sub: 'A preview of the tips, meals and routines waiting in your plan.',
      footer: 'Plus the full library, unlocked the moment you start.',
      tag_tip: 'TIP',
      tag_meal: 'MEAL',
      tag_light: 'LIGHT',
      tag_movement: 'MOVEMENT',
      tag_lesson: 'LESSON',
      t_sunglasses: 'Sunglasses on the drive home',
      t_478: '4-7-8 wind-down (90s)',
      t_snack: 'Anti-reflux pre-sleep snack',
      t_brightblock: '20-min bright-light block at 2 a.m.',
      t_walk: '10-min daylight walk before sleep',
      t_cooldark: 'Cool, blackout-dark bedroom setup',
      lock_premium: 'Premium',
      lock_more: '+30 more',
      lock_day7: 'Unlocks Day 7',
    },
    trust: {
  ...
  paywall: {
    ...
    weekly_label: "WEEKLY",
    trial_timeline: "{{days}}-DAY TRIAL TIMELINE",
    best_value: "BEST VALUE",
    best_value_save: "BEST VALUE · SAVE {{percent}}%",
    start_trial: "Start {{days}}-day free trial",
    cta_sub_year: "{{days}} days free, then {{price}} / year · cancel anytime",
    cta_sub_month: "{{days}} days free, then {{price}} / month · cancel anytime",
    cta_sub_week: "{{days}} days free, then {{price}} / week · cancel anytime",
    starting_trial: "Starting trial…",
    subscribe_now_year: "Subscribe — {{price}} / year",
    subscribe_now_month: "Subscribe — {{price}} / month",
    subscribe_now_week: "Subscribe — {{price}} / week",
    cta_sub_notrial_year: "{{price}} / year · cancel anytime",
    cta_sub_notrial_month: "{{price}} / month · cancel anytime",
    cta_sub_notrial_week: "{{price}} / week · cancel anytime",
    charge_on_year: "No charge until {{date}} — then {{price}} / year",
    charge_on_month: "No charge until {{date}} — then {{price}} / month",
    charge_on_week: "No charge until {{date}} — then {{price}} / week",
    timeline_today: "Today · Full access unlocked",
    timeline_reminder: "Day {{day}} · We remind you before it ends",
    timeline_charge: "Day {{days}} · Trial ends, then {{price}}",
  ...
  notifications: {
    ...
    trial_ending_title: 'Your free trial ends tomorrow',
    trial_ending_body: 'Here’s what you’ll keep: your sleep window, caffeine cutoff, and shift-transition plans. Cancel anytime before then.',
  },
  date: {
    months_full: [
  ...
  settings_screens: {
    ...
    subscription: {
      ...
      restore_title: 'Restore purchases',
      restore_link: 'Restore purchases',
      restore_placeholder: 'Purchases restore automatically when you sign in with the same {{account}} you bought with. Reopen the plan screen to restore manually.',
      resubscribe: 'Resubscribe',
      store_unavailable: 'Could not open {{store}}',
      bullets: {
